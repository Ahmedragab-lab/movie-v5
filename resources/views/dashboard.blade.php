                    ...
                    <div class="row row-group m-0">
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                                ...
                                <h5 class="text-white mb-0" style="display: none" id="genres-count">  <span class="float-right">
                                </span></h5>
                        ...
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                                <div class="loader"></div>
                                <h5 class="text-white mb-0" style="display: none" id="movies-count"> <span class="float-right">
                                </span></h5>
                        ...
                        <div class="col-12 col-lg-6 col-xl-3 border-light">
                            <div class="card-body">
                                <div class="loader"></div>
                                <h5 class="text-white mb-0" style="display: none" id="actors-count"> <span class="float-right">
                                </span></h5>
